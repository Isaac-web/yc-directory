...
// Variable: GET_USER_BY_GITHUB_ID
// Query: *[_type == "author" && id == $id ][0]{_id, id, name, email, username, bio}
export type GET_USER_BY_GITHUB_IDResult = {
  _id: string;
  id: number | null;
  name: string | null;
  email: string | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == \"author\" && id == $id ][0]{_id, id, name, email, username, bio}": GET_USER_BY_GITHUB_IDResult;
  }
}
